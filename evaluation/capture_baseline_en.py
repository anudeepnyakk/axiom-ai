"""
Captures English baseline metrics for Axiom AI retrieval evaluation.

This script runs the evaluation and saves a clean baseline report with
Recall@1/5/10, MRR, and latency metrics.

Usage:
    python evaluation/capture_baseline_en.py
"""
...
async def main():
    ...
    print("Capturing English baseline for Axiom AI...")
    ...
    print(f"Running retrieval for {len(test_cases)} queries...")
    ...
    # 5. Save baseline
    output_path = Path(__file__).parent / "baseline_en.json"
    with open(output_path, "w") as f:
        json.dump(baseline_metrics, f, indent=4)
    
    print(f"\nBaseline captured successfully: {output_path}")
    print("\nMetrics:")
